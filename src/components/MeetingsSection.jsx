...
import zoom from '../assets/all.svg'
...
export default function MeetingsSection() {
    return (
        <div>
            ...
            <div
                className="w-[756px] h-[280.13px] bg-white rounded-[16px] shadow-[0px_12px_32px_0px_rgba(0,0,0,0.05)] border border-[#0000000D] flex font-inter"
            >
                ...
                {/* Right Side - Faces */}
                <div className="w-[196] h-[194] relative flex items-center justify-center">

              ...
              >
                ...
                <div className="p-4">
                  <div className="flex items-center gap-3">
                    {user?.profilePic ? (
                      <img src={user.profilePic} className="w-9 h-9 rounded-md" alt="" />
                    ) : (
            ...
            {showChatHistory && (
              <AnimatePresence>
                ...
                >
                  ...
                  <div className="w-[234px] h-[40px] flex items-center border border-[#E5E5E5] rounded-[6px] px-2 py-1 gap-2 bg-white">
